...
<html>
<head>
    <title style="text-align: center; color: #020053">User Table</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css">
</head>
<body>
<div class="container">
    <h2 style="text-align: center; color: #020053"> User Table</h2>
    <table class="table table-striped">
        <thead>
        <tr>
            <th style="color: #020053">Name</th>
            <th style="color: #020053">Email</th>
            <th style="color: #020053">Registration Date</th>
